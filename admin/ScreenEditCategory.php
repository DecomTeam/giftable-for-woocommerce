...
class DGFW_ScreenEditCategory extends DGFW_Screen {
    ...
    public function translations()
    {
        return array(
            ...
            'This condition will be met if the <strong>total number of items in cart</strong> is within the defined min/max items range.' => __('This condition will be met if the <strong>total number of items in cart</strong> is within the defined min/max items range.', DGFW::TRANSLATION),
            'Products' => __('Products', DGFW::TRANSLATION),
            'This condition will be met if the customer has at least one item of any of the selected products in their cart. To specify minimum quantity for each product, click the <strong>Product Quantities</strong> button below.' => __('This condition will be met if the customer has at least one item of any of the selected products in their cart. To specify minimum quantity for each selected product, click the <strong>Product Quantities</strong> button below.', DGFW::TRANSLATION),
            ...
            'This condition will be met if the customer is any of the selected users.' => __('This condition will be met if the customer is any of the selected users.', DGFW::TRANSLATION),
            'User Roles' => __('User Roles', DGFW::TRANSLATION),
            'This condition will be met if the customr is a logged in ser and has one of the user roles selected below.' => __('This condition will be met if the customr is a logged in ser and has one of the user roles selected below.', DGFW::TRANSLATION),
            ...
            'Set up minimum amount and/or number of items for each selected category.' => __('Set up minimum amount and/or number of items for each selected category.', DGFW::TRANSLATION),
