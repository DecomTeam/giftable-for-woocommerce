(function () {
	...
	var Debug = function () {
	    ...
	    babelHelpers.createClass(Debug, null, [{
	        key: "isEnabled",
	...
	var BoundElement = function () {
	    function BoundElement() {
	        ...
	        babelHelpers.classCallCheck(this, BoundElement);
	    ...
	    babelHelpers.createClass(BoundElement, [{
	        key: 'unbind',
	...
	var Translate = function () {
	    ...
	    babelHelpers.createClass(Translate, null, [{
	...
	var Criteria = function () {
	    function Criteria(id) {
	        ...
	        babelHelpers.classCallCheck(this, Criteria);
	    ...
	    babelHelpers.createClass(Criteria, [{
	        key: 'init',
	        value: function init() {
	            this.hideNavigation();
	        ...
	        value: function removeStepElements(stepIndex) {
	            ...
	            this._sourceCriteria._steps[stepIndex].elements.forEach(function (element, index, collection) {
	                ...
	                $(document.getElementById('dgfw_criteria_' + _this6._sourceCriteria.id() + '_step_' + stepIndex)).fadeOut().remove();
	            });
	        }
	    }, {
	        key: 'showNavigation',
	...
	var MetaCurrency = function (_Meta) {
	    babelHelpers.inherits(MetaCurrency, _Meta);

	    function MetaCurrency() {
	        babelHelpers.classCallCheck(this, MetaCurrency);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(MetaCurrency).apply(this, arguments));
	    }

	    babelHelpers.createClass(MetaCurrency, [{
	        key: 'init',
	        value: function init() {
	            ...
	            babelHelpers.get(Object.getPrototypeOf(MetaCurrency.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'hookElements',
	        value: function hookElements() {
	            babelHelpers.get(Object.getPrototypeOf(MetaCurrency.prototype), 'hookElements', this).call(this);
	...
	var CriteriaAmounts = function (_Criteria) {
	    babelHelpers.inherits(CriteriaAmounts, _Criteria);

	    function CriteriaAmounts() {
	        babelHelpers.classCallCheck(this, CriteriaAmounts);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(CriteriaAmounts).apply(this, arguments));
	    }

	    babelHelpers.createClass(CriteriaAmounts, [{
	        key: 'init',
	        value: function init() {
	            this._type = 'amounts';
	            if (this._sourceCriteria) {
	            ...
	            babelHelpers.get(Object.getPrototypeOf(CriteriaAmounts.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'changeCurrency',
	...
	var MetaQuantity = function (_Meta) {
		babelHelpers.inherits(MetaQuantity, _Meta);

		function MetaQuantity() {
			babelHelpers.classCallCheck(this, MetaQuantity);
			return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(MetaQuantity).apply(this, arguments));
		}

		babelHelpers.createClass(MetaQuantity, [{
			key: 'init',
			value: function init() {
				this._label = this._options.label;
				...
				babelHelpers.get(Object.getPrototypeOf(MetaQuantity.prototype), 'init', this).call(this);
			}
		}, {
			key: 'validate',
			value: function validate() {
	...
	var CriteriaItems = function (_Criteria) {
	    babelHelpers.inherits(CriteriaItems, _Criteria);

	    function CriteriaItems() {
	        babelHelpers.classCallCheck(this, CriteriaItems);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(CriteriaItems).apply(this, arguments));
	    }

	    babelHelpers.createClass(CriteriaItems, [{
	        key: 'init',
	        value: function init() {
	            this._type = 'items';
	            ...
	            babelHelpers.get(Object.getPrototypeOf(CriteriaItems.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'updateMinItems',
	...
	var MetaPosts = function (_Meta) {
	    babelHelpers.inherits(MetaPosts, _Meta);

	    function MetaPosts() {
	        babelHelpers.classCallCheck(this, MetaPosts);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(MetaPosts).apply(this, arguments));
	    }

	    babelHelpers.createClass(MetaPosts, [{
	        key: 'init',
	        value: function init() {
	            var _this2 = this;
	            ...
	            babelHelpers.get(Object.getPrototypeOf(MetaPosts.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'hookElements',
	        value: function hookElements() {
	            babelHelpers.get(Object.getPrototypeOf(MetaPosts.prototype), 'hookElements', this).call(this);
	...
	var CriteriaProducts = function (_Criteria) {
	    babelHelpers.inherits(CriteriaProducts, _Criteria);

	    function CriteriaProducts() {
	        babelHelpers.classCallCheck(this, CriteriaProducts);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(CriteriaProducts).apply(this, arguments));
	    }

	    babelHelpers.createClass(CriteriaProducts, [{
	        key: 'init',
	        value: function init() {
	            this._type = 'products';
	            ...
	            babelHelpers.get(Object.getPrototypeOf(CriteriaProducts.prototype), 'init', this).call(this);
	        }
	    }]);
	...
	var MetaTerms = function (_Meta) {
	    babelHelpers.inherits(MetaTerms, _Meta);

	    function MetaTerms() {
	        babelHelpers.classCallCheck(this, MetaTerms);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(MetaTerms).apply(this, arguments));
	    }

	    babelHelpers.createClass(MetaTerms, [{
	        key: 'init',
	        value: function init() {
	            var _this2 = this;
	            ...
	            babelHelpers.get(Object.getPrototypeOf(MetaTerms.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'termElement',
	...
	var CriteriaProductCategories = function (_Criteria) {
	    babelHelpers.inherits(CriteriaProductCategories, _Criteria);

	    function CriteriaProductCategories() {
	        babelHelpers.classCallCheck(this, CriteriaProductCategories);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(CriteriaProductCategories).apply(this, arguments));
	    }

	    babelHelpers.createClass(CriteriaProductCategories, [{
	        key: 'init',
	        value: function init() {
	            ...
	            babelHelpers.get(Object.getPrototypeOf(CriteriaProductCategories.prototype), 'init', this).call(this);
	        }
	    }]);
	...
	var MetaUsers = function (_Meta) {
	    babelHelpers.inherits(MetaUsers, _Meta);

	    function MetaUsers() {
	        babelHelpers.classCallCheck(this, MetaUsers);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(MetaUsers).apply(this, arguments));
	    }

	    babelHelpers.createClass(MetaUsers, [{
	        key: 'init',
	        value: function init() {
	            var _this2 = this;
	            ...
	            babelHelpers.get(Object.getPrototypeOf(MetaUsers.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'hookElements',
	        value: function hookElements() {
	            babelHelpers.get(Object.getPrototypeOf(MetaUsers.prototype), 'hookElements', this).call(this);
	            this._$containerElement = this._$containerElement || $(document.getElementById(this._containerId));
	            this._$selectedListElement = this._$selectedListElement || $(document.getElementById(this._selectedListId));
	            this._$currentPageStatus = this._$currentPageStatus || $(document.getElementById(this._statusCurrentPageId));
	        }
	...
	var CriteriaUsers = function (_Criteria) {
	    babelHelpers.inherits(CriteriaUsers, _Criteria);

	    function CriteriaUsers() {
	        babelHelpers.classCallCheck(this, CriteriaUsers);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(CriteriaUsers).apply(this, arguments));
	    }

	    babelHelpers.createClass(CriteriaUsers, [{
	        key: 'init',
	        value: function init() {
	            this._type = 'users';
	            ...
	            babelHelpers.get(Object.getPrototypeOf(CriteriaUsers.prototype), 'init', this).call(this);
	        }
	    }]);
	...
	var MetaRoles = function (_Meta) {
	    babelHelpers.inherits(MetaRoles, _Meta);

	    function MetaRoles() {
	        babelHelpers.classCallCheck(this, MetaRoles);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(MetaRoles).apply(this, arguments));
	    }

	    babelHelpers.createClass(MetaRoles, [{
	        key: 'init',
	        value: function init() {
	            var _this2 = this;
	            ...
	            babelHelpers.get(Object.getPrototypeOf(MetaRoles.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'roleElement',
	...
	var CriteriaUserRoles = function (_Criteria) {
	    babelHelpers.inherits(CriteriaUserRoles, _Criteria);

	    function CriteriaUserRoles() {
	        babelHelpers.classCallCheck(this, CriteriaUserRoles);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(CriteriaUserRoles).apply(this, arguments));
	    }

	    babelHelpers.createClass(CriteriaUserRoles, [{
	        key: 'init',
	        value: function init() {
	            ...
	            babelHelpers.get(Object.getPrototypeOf(CriteriaUserRoles.prototype), 'init', this).call(this);
	        }
	    }]);
	...
	var MetaTime = function (_Meta) {
	    babelHelpers.inherits(MetaTime, _Meta);

	    function MetaTime() {
	        babelHelpers.classCallCheck(this, MetaTime);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(MetaTime).apply(this, arguments));
	    }

	    babelHelpers.createClass(MetaTime, [{
	        key: 'init',
	        value: function init() {
	            this._label = this._options.label;
	            ...
	            babelHelpers.get(Object.getPrototypeOf(MetaTime.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'hookElements',
	        value: function hookElements() {
	...
	var CriteriaPeriods = function (_Criteria) {
	    babelHelpers.inherits(CriteriaPeriods, _Criteria);

	    function CriteriaPeriods() {
	        babelHelpers.classCallCheck(this, CriteriaPeriods);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(CriteriaPeriods).apply(this, arguments));
	    }

	    babelHelpers.createClass(CriteriaPeriods, [{
	        key: 'init',
	        value: function init() {
	            this._type = 'periods';
	            ...
	            babelHelpers.get(Object.getPrototypeOf(CriteriaPeriods.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'updateStartDate',
	...
	var CriteriaFactory = function () {
	    function CriteriaFactory() {
	        babelHelpers.classCallCheck(this, CriteriaFactory);
	    }

	    babelHelpers.createClass(CriteriaFactory, null, [{
	        key: 'create',
	...
	var ScreenEditCategory = function (_Screen) {
	    babelHelpers.inherits(ScreenEditCategory, _Screen);

	    function ScreenEditCategory() {
	        babelHelpers.classCallCheck(this, ScreenEditCategory);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(ScreenEditCategory).apply(this, arguments));
	    }

	    babelHelpers.createClass(ScreenEditCategory, [{
	        key: 'init',
	        value: function init() {
	            ...
	            babelHelpers.get(Object.getPrototypeOf(ScreenEditCategory.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'addCriteria',
	        value: function addCriteria() {
	...
	var ScreenEditProduct = function (_Screen) {
	    babelHelpers.inherits(ScreenEditProduct, _Screen);

	    function ScreenEditProduct() {
	        babelHelpers.classCallCheck(this, ScreenEditProduct);
	        return babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(ScreenEditProduct).apply(this, arguments));
	    }

	    babelHelpers.createClass(ScreenEditProduct, [{
	        key: 'init',
	        value: function init() {
	            ...
	            babelHelpers.get(Object.getPrototypeOf(ScreenEditProduct.prototype), 'init', this).call(this);
	        }
	    }, {
	        key: 'toggleGiftable',
	...
	var ScreenFactory = function () {
	    function ScreenFactory() {
	        babelHelpers.classCallCheck(this, ScreenFactory);
	    }

	    babelHelpers.createClass(ScreenFactory, null, [{
	        key: 'create',
